import re
#regular expression imported from the python library
import random
#the random module is a python library that can extend the basic features of python.i this used
#this library to pick random words from the lyrics of my song to generate a whole new song.
from collections import defaultdict, deque
#I imported defaultdict and dequeue classes from the collections library
"""
